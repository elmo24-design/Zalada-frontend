...
export const listProducts = (keyword = '', pageNumber = '') => async (dispatch) => { 
   try{
      ...
      const { data } = await axios.get(`${process.env.REACT_APP_API}/api/products?keyword=${keyword}&pageNumber=${pageNumber}`)
...
export const listTopProducts = () => async (dispatch) => { 
   try{
      ...
      const { data } = await axios.get(`${process.env.REACT_APP_API}/api/products/top`)
...
export const createProductReview = (productId, review) => async(dispatch, getState) => {
   try{
      ...
      await axios.post(`${process.env.REACT_APP_API}/api/products/${productId}/reviews`, review, config)
